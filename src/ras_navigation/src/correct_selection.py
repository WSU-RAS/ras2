...
class Navigation_wrapper():
    ...
    def __init__(self):
        rospy.init_node('navigation_wrapper')
        self.map_data = None
    ...
    def create_service(self):
        rospy.Service('Navigation_correction', MoveBaseGoal, self.service_callback)
    ...
    def create_listener(self):
        rospy.Subscriber('map', OccupancyGrid, self.listener_callback)

    def listener_callback(self, data):
        self.data = data

if __name__ == '__main__':
    rospy.loginfo("Beginning correct_selection service")
    Navigation_wrapper()
    rospy.spin()
    rospy.loginfo("Ending correct_selection service")
